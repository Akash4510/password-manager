...
namespace eval ttk::theme::proxttk-dark {

    variable version 1.3
    package provide ttk::theme::proxttk-dark $version
    variable colors
    array set colors {
        -fg             "#ffffff"
        -bg             "#333333"
    ...
    LoadImages [file join [file dirname [info script]] proxttk-dark]

    # Settings
    ttk::style theme create proxttk-dark -parent default -settings {
        ttk::style configure . \
